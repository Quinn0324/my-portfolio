...
export default function Footer() {
    return(
        <div className="h-auto lg:h-[15rem] px-4 sm:px-8 py-8 flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0 border-t border-[rgba(255,250,240,0.1)]">
