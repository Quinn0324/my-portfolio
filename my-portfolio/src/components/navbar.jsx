...
export default function Navbar() {
  ...
  return (
    <nav className="font-sans flex justify-between items-center px-8 py-4 shadow-sm h-[6.375rem] bg-fade-black fixed w-full z-[9999]">
      ...
      <div className="flex gap-[2.5rem] text-sm">
